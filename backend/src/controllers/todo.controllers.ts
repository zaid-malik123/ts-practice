...
const createTodo = TryCatch(async (req: any, res: Response) => {
...
const getAllTodo = TryCatch(async (req: any, res: Response) => {
...
const updateTodo = TryCatch(async (req: any, res: Response) => {
  const { id } = req.params;
...
const deleteTodo = TryCatch(async (req: any, res: Response) => {
  const { id } = req.params;
...
const getSingleTodo = TryCatch(async (req: any, res: Response) => {
  const { id } = req.params;
  const userId = req.user.id;
